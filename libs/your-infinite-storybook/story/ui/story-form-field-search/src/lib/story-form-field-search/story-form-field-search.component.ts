...
import { StoryOnStoryFormFieldSearchYourInfiniteStorybookStoryUiStoryFormFieldSearchFragment as StoryFragment } from './__generated__/story-form-field-search.component.graphql';

@Component({
    selector: 'your-infinite-storybook-story-ui-story-form-field-search',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './story-form-field-search.component.pug',
    styleUrls: ['./story-form-field-search.component.scss']
})
export class StoryFormFieldSearchComponent implements OnInit {

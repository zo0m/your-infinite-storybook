...
import { StoryOnStoryRemoveButtonYourInfiniteStorybookStoryUiStoryRemoveButtonFragment as StoryFragment } from './__generated__/story-remove-button.component.graphql';

@Component({
    selector: 'your-infinite-storybook-story-ui-story-remove-button',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './story-remove-button.component.pug',
    styleUrls: ['./story-remove-button.component.scss']
})
export class StoryRemoveButtonComponent implements OnInit {

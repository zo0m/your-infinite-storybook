...
import { StoryOnStoryEditButtonYourInfiniteStorybookStoryUiStoryEditButtonFragment as StoryFragment } from './__generated__/story-edit-button.component.graphql';

@Component({
    selector: 'your-infinite-storybook-story-ui-story-edit-button',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './story-edit-button.component.pug',
    styleUrls: ['./story-edit-button.component.scss']
})
export class StoryEditButtonComponent implements OnInit {

...
import { StoryOnStoryFormFieldSelectYourInfiniteStorybookStoryUiStoryFormFieldSelectFragment as StoryFragment } from './__generated__/story-form-field-select.component.graphql';

@Component({
    selector: 'your-infinite-storybook-story-ui-story-form-field-select',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './story-form-field-select.component.pug',
    styleUrls: ['./story-form-field-select.component.scss']
})
export class StoryFormFieldSelectComponent implements OnInit {

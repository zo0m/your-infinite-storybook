...
import { MessageOnMessageEditButtonYourInfiniteStorybookMessageUiMessageEditButtonFragment as MessageFragment } from './__generated__/message-edit-button.component.graphql';

@Component({
    selector: 'your-infinite-storybook-message-ui-message-edit-button',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './message-edit-button.component.pug',
    styleUrls: ['./message-edit-button.component.scss']
})
export class MessageEditButtonComponent implements OnInit {

...
import { MessageOnMessageFormFieldSearchYourInfiniteStorybookMessageUiMessageFormFieldSearchFragment as MessageFragment } from './__generated__/message-form-field-search.component.graphql';

@Component({
    selector: 'your-infinite-storybook-message-ui-message-form-field-search',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './message-form-field-search.component.pug',
    styleUrls: ['./message-form-field-search.component.scss']
})
export class MessageFormFieldSearchComponent implements OnInit {

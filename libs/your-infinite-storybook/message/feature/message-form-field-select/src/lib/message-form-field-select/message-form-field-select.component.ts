...
import {
    GetMessageOnMessageFormFieldSelectYourInfiniteStorybookMessageFeatureMessageFormFieldSelectGQL as GetMessageGQL,
    GetMessageOnMessageFormFieldSelectYourInfiniteStorybookMessageFeatureMessageFormFieldSelectQuery as GetMessageQuery,
    MessageOnMessageFormFieldSelectYourInfiniteStorybookMessageFeatureMessageFormFieldSelectFragment as MessageFragment,
    SearchMessagesOnMessageFormFieldSelectYourInfiniteStorybookMessageFeatureMessageFormFieldSelectGQL as SearchMessagesGQL,
    SearchMessagesOnMessageFormFieldSelectYourInfiniteStorybookMessageFeatureMessageFormFieldSelectQuery as SearchMessagesQuery
} from './__generated__/message-form-field-select.component.graphql';

@Component({
    selector:
        'your-infinite-storybook-message-feature-message-form-field-select',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './message-form-field-select.component.pug',
    styleUrls: ['./message-form-field-select.component.scss']
})
export class MessageFormFieldSelectComponent {

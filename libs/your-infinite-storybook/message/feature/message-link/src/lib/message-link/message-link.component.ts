...
import {
    GetMessageOnMessageLinkYourInfiniteStorybookMessageFeatureMessageLinkGQL as GetMessageGQL,
    GetMessageOnMessageLinkYourInfiniteStorybookMessageFeatureMessageLinkQuery as GetMessageQuery,
    MessageOnMessageLinkYourInfiniteStorybookMessageFeatureMessageLinkFragment as MessageFragment
} from './__generated__/message-link.component.graphql';

@Component({
    selector: 'your-infinite-storybook-message-feature-message-link',

...
import { UserOnUserFormFieldSelectYourInfiniteStorybookUserUiUserFormFieldSelectFragment as UserFragment } from './__generated__/user-form-field-select.component.graphql';

@Component({
    selector: 'your-infinite-storybook-user-ui-user-form-field-select',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './user-form-field-select.component.pug',
    styleUrls: ['./user-form-field-select.component.scss']
})
export class UserFormFieldSelectComponent implements OnInit {

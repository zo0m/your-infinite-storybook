...
import { UserOnUserRemoveButtonYourInfiniteStorybookUserUiUserRemoveButtonFragment as UserFragment } from './__generated__/user-remove-button.component.graphql';

@Component({
    selector: 'your-infinite-storybook-user-ui-user-remove-button',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './user-remove-button.component.pug',
    styleUrls: ['./user-remove-button.component.scss']
})
export class UserRemoveButtonComponent implements OnInit {

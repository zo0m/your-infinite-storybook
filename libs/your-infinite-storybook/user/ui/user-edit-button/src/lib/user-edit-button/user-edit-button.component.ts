...
import { UserOnUserEditButtonYourInfiniteStorybookUserUiUserEditButtonFragment as UserFragment } from './__generated__/user-edit-button.component.graphql';

@Component({
    selector: 'your-infinite-storybook-user-ui-user-edit-button',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './user-edit-button.component.pug',
    styleUrls: ['./user-edit-button.component.scss']
})
export class UserEditButtonComponent implements OnInit {

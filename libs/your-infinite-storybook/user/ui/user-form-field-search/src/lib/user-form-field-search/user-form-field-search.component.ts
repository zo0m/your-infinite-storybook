...
import { UserOnUserFormFieldSearchYourInfiniteStorybookUserUiUserFormFieldSearchFragment as UserFragment } from './__generated__/user-form-field-search.component.graphql';

@Component({
    selector: 'your-infinite-storybook-user-ui-user-form-field-search',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './user-form-field-search.component.pug',
    styleUrls: ['./user-form-field-search.component.scss']
})
export class UserFormFieldSearchComponent implements OnInit {

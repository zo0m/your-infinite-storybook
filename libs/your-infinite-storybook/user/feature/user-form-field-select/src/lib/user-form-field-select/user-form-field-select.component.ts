...
import {
    GetUserOnUserFormFieldSelectYourInfiniteStorybookUserFeatureUserFormFieldSelectGQL as GetUserGQL,
    GetUserOnUserFormFieldSelectYourInfiniteStorybookUserFeatureUserFormFieldSelectQuery as GetUserQuery,
    SearchUsersOnUserFormFieldSelectYourInfiniteStorybookUserFeatureUserFormFieldSelectGQL as SearchUsersGQL,
    SearchUsersOnUserFormFieldSelectYourInfiniteStorybookUserFeatureUserFormFieldSelectQuery as SearchUsersQuery,
    UserOnUserFormFieldSelectYourInfiniteStorybookUserFeatureUserFormFieldSelectFragment as UserFragment
} from './__generated__/user-form-field-select.component.graphql';

@Component({
    selector: 'your-infinite-storybook-user-feature-user-form-field-select',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './user-form-field-select.component.pug',
    styleUrls: ['./user-form-field-select.component.scss']
})
export class UserFormFieldSelectComponent {
